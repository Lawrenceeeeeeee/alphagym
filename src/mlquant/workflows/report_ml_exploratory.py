...
from mlquant.workflows._support import finish, invoke, validate_config
...
def write_report(output: Path) -> None:
    ...
    storage_io.write_bytes(static / "echarts.min.js", storage_io.read_bytes(files("mlquant").joinpath("static/echarts.min.js")))
