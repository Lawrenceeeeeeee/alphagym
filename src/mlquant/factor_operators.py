...
from mlquant.factor_dsl import (
    FieldRef,
    FieldRegistry,
    ModelRef,
    OperatorRegistry,
...
from mlquant.factors.base import FactorContext, FieldDefinition
...
def _technical(context: FactorContext, output: str) -> pd.Series:
    from mlquant.factors.technical import compute_technical_features
